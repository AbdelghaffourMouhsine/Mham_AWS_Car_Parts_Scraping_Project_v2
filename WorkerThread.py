...
class WorkerThread(threading.Thread):
    ...
    def init_start_end(self):
        self.start_brand = self.brand_dic.get("start_brand")
        self.start_year = self.brand_dic.get("start_year")
        self.start_model = self.brand_dic.get("start_model")
        self.start_elem_X = self.brand_dic.get("start_elem_X")
        self.start_elem_XX = self.brand_dic.get("start_elem_XX")
        self.start_part_name = self.brand_dic.get("start_part_name")
        
        self.end_brand = self.brand_dic.get("end_brand")
        self.end_year = self.brand_dic.get("end_year")
        self.end_model = self.brand_dic.get("end_model")
        self.end_elem_X = self.brand_dic.get("end_elem_X")
        self.end_elem_XX = self.brand_dic.get("end_elem_XX")
        self.end_part_name = self.brand_dic.get("end_part_name")
